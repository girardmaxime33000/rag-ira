...
9. **Plage de données / période exploitable** : la section « Faits chiffrés » ci-dessous n'est qu'un échantillon (les lignes les plus récentes, tronquées). Si la question porte sur la plage de données disponible, la période couverte ou l'étendue temporelle de la base, appuie-toi exclusivement sur la section « Couverture temporelle des données » — jamais sur les seules années visibles dans l'échantillon de Faits chiffrés, qui sous-estimerait la plage réelle.
